...
export const StyledCheckbox = styled(Checkbox)<{ size: CheckboxProps['size'] }>(({ theme, size }) => ({
...
export const StyledCheckboxFormControlLabel = styled(FormControlLabel)<{ size: CheckboxProps['size'] }>(
    ({ theme, size }) => ({
        margin: 0,
