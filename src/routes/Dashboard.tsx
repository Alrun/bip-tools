...
const options = [
    ...
    {
        label: 'Long Long Long Long Long Long Long Long Long Option 3',
        value: '3'
    },
    {
        label: 'Option 4',
    ...
    return (
        <>
            ...
            <Grid container spacing={8} sx={{ px: 24 }}>
                ...
                {/*    <Autocomplete*/}
                {/*        options={manyOptions(30)}*/}
                {/*        label="Object Grouped"*/}
                {/*        onChange={() => {}}*/}
                {/*        groupBy={(option: any) => option.label[0].toUpperCase()}*/}
                {/*    />*/}
                {/*</Grid>*/}
                ...
                {/*</Grid>*/}
                {/*<Grid item xs={12} sm={3} mb={20}>*/}
                {/*    <Autocomplete highlight options={manyOptions(30)} label="Object Highlight" onChange={() => {}} />*/}
                {/*</Grid>*/}
                {/*<Grid item xs={12} sm={3} mb={20}>*/}
                {/*    <Autocomplete*/}
                {/*        highlight*/}
                {/*        options={enList.slice(2000, 2048)}*/}
                {/*        label="Array Grouped Highlight"*/}
                {/*        onChange={() => {}}*/}
                {/*        groupBy={(option: any) => option[0].toUpperCase()}*/}
                {/*    />*/}
                {/*</Grid>*/}
                ...
                {/*        highlight*/}
                {/*        options={manyOptions(30)}*/}
                {/*        label="Object Grouped Highlight"*/}
                {/*        onChange={() => {}}*/}
                {/*        groupBy={(option: any) => option.label[0].toUpperCase()}*/}
                {/*    />*/}
                {/*</Grid>*/}
                ...
                {/*        options={(countries as any).sort((a: any, b: any) => {*/}
